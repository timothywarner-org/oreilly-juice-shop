...
## MS Press Course Edition

This fork is the official demo codebase for **GitHub Copilot for Cybersecurity Professionals** (MS Press).

### Quick Start for Course
...
| Directory | Purpose |
|-----------|---------|
| `demos/` | Lesson runbooks (01-05) with step-by-step instructions |
| `labs/` | Lab exercises organized by lesson |
| `iac/juice-shop-insecure/` | Intentionally vulnerable Terraform |
| `iac/juice-shop-hardened/` | Secure baseline Terraform |
| `scripts/` | GHAS and compliance automation tools |

### Lessons

1. **Lesson 01:** Vulnerability Detection (SQL injection, XSS, IDOR)
2. **Lesson 02:** Security Protocols (OAuth, JWT, encryption, zero-trust IaC)
3. **Lesson 03:** Automated Testing (fuzzing, SAST/DAST, CI/CD gates)
4. **Lesson 04:** Code Review & Auditing (STRIDE, Semgrep, compliance)
5. **Lesson 05:** Compliance & IR (CIS/NIST, STIG, incident response)

See [COURSE-SETUP.md](COURSE-SETUP.md) for detailed environment setup.
